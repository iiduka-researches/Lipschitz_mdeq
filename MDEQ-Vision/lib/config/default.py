...
_C.MODEL.CONTRACTIVE = 'none'
_C.MODEL.TARGET_NORM = 1.0
_C.MODEL.ACTIVATION = 'ReLU'
_C.MODEL.RELU_SLOPE = 1.0
_C.MODEL.RESIDUAL_ALPHA = 0.0
_C.MODEL.FUSION_BETA = 0.0
_C.MODEL.USE_STD_IN_GN = True
_C.MODEL.GN_GAMMA_CLIP = 0.0
_C.MODEL.USE_SOFTMAX = True
_C.MODEL.BACKWARD_METHOD = 'implicit' #implicit, phantom_gradient, jfb
_C.MODEL.PG_TAU = 1.0
_C.MODEL.PG_STEPS = 3
